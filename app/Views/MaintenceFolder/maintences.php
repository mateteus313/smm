            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            <?php foreach ($maintences as $maintence) : ?>
                                <tr>
                                    <td><?= $maintence['id'] ?></td>
                                    <td><?= $maintence['computer_id'] ?></td>
                                    <td><?= $maintence['description'] ?></td>
                                    <td><?= $maintence['resolved'] ?></td>
                                    <td><?= $maintence['created_at'] ?></td>
                                    <td><?= $maintence['updated_at'] ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
